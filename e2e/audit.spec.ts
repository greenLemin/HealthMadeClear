...
const LIVE_URL = "https://healthmadeclear.netlify.app";
...
test.describe("Exhaustive UI/UX live site audit", () => {
  test.afterAll(() => {
    writeFileSync("audit-results-raw.json", JSON.stringify(auditResults, null, 2));
    console.log("Raw audit results saved to audit-results-raw.json");
  });
