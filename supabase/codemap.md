...
- `repair/history-match-001-013.sql`: Apply-time runbook (not a forward migration). CLI `migration repair --status applied 001…013` plus live timestamp inventory. Park 015 before the 014 push.
