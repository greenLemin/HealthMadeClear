  ...
  return (
    <main className="py-12 md:py-16">
      <div className="max-w-container mx-auto px-4 md:px-6">
        <PageHeader badge={copy.paths.pageBadge} title={copy.paths.pageTitle} description={copy.learn.description} />
                ...
                <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
                  <div>
                    ...
                    <div className="mb-3 flex items-center justify-between text-sm font-semibold text-on-surface-variant">
                      <span>
                        {copy.paths.lesson} {Math.min(progress.completedCount + 1, Math.max(progress.totalCount, 1))}{" "}
                        {copy.common.of} {progress.totalCount}
                      </span>
                      <span>
                        {progress.percentage}% {copy.paths.complete}
                      </span>
                    </div>
                    <div
