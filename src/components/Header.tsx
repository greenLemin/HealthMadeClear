      ...
      <div className="mx-auto max-w-container">
        <div className="surface-card-glass relative overflow-hidden px-4 md:px-6">
          ...
          <div className="flex min-h-[76px] items-center justify-between gap-4 py-3">
            ...
            <DesktopNav navItems={navItems} pathname={pathname} t={t} />
...
function DesktopNav({ navItems, pathname, t }: { navItems: NavItem[]; pathname: string; t: any }) {
  return (
    <nav
    ...
    <div className="hidden items-center gap-2 lg:gap-3 lg:flex 2xl:gap-1.5">
      {loading ? (
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <User size={16} />
            <TruncatedText className="max-w-[120px] truncate 2xl:max-w-[80px]">{displayName}</TruncatedText>
          </Link>
          <button
            type="button"
            onClick={onSignOut}
        ...
        <div className="flex items-center gap-2">
          ...
          <ButtonLink href="/auth/signup" size="sm" className="min-h-11 px-4 text-label-md 2xl:hidden">
            {authT("signupButton")}
          </ButtonLink>
        </div>
      )}
