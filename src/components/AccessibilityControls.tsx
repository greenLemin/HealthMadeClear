...
function ThemeControls({ t }: { t: ReturnType<typeof useTranslations<"accessibility">> }) {
...
function SimpleModeControl({ t }: { t: ReturnType<typeof useTranslations<"accessibility">> }) {
