...
describe("useDismissibleOverlay", () => {
  ...
  const setupDOM = () => {
    ...
    const containerRef = createRef<HTMLElement>() as RefObject<HTMLElement | null>;
    // @ts-ignore - write to readonly for mocking
    containerRef.current = container;

    const triggerRef = createRef<HTMLElement>() as RefObject<HTMLElement | null>;
    // @ts-ignore
    triggerRef.current = trigger;

    const returnFocusRef = createRef<HTMLElement>() as RefObject<HTMLElement | null>;
    // @ts-ignore
