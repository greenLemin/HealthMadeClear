...
**CF-21 — Compact-at-xl ∪ Playwright overflow on `/en` only ∪ real (short) Spanish labels.**  
Panel math used labels that are not in the nav. The remaining hole is the test locale.  
**v4:** Same compact-at-xl. Add `/es` overflow assertions at 1280 and 1440. No dropdown.
